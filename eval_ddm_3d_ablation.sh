#!/bin/bash
#SBATCH --job-name=eval_ddm3d_ablation
#SBATCH --output=logs/eval_ddm3d_ablation_%A_%a.out
#SBATCH --gpus=1
#SBATCH --time=01:00:00
#SBATCH --mem-per-cpu=16G
#SBATCH --array=0-19
#SBATCH --dependency=afterok:4394348
...
CKPT="results/ddm_3d_ablation/n${N}_s${S}/ddm_3d_ablation_n${N}_s${S}_best.pth"
