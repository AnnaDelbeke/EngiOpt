...
from engiopt.eval_utils import parse_condition_filter_values
...
if __name__ == "__main__":
    ...
    for fv in parse_condition_filter_values(args):
        ...
        if args.wandb_entity is not None:
            artifact_path = (
                f"{args.wandb_entity}/{args.wandb_project}/{args.problem_id}_cgan_2d_imgcond_generator:{alias}"
            )
        else:
            artifact_path = f"{args.wandb_project}/{args.problem_id}_cgan_2d_imgcond_generator:{alias}"
